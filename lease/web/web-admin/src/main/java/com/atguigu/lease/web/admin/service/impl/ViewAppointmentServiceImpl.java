...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> selectAppointmentPage(Page<AppointmentVo> page, AppointmentQueryVo queryVo) {
        IPage<AppointmentVo> pageModel = viewAppointmentMapper.selectAppointmentPage(page,queryVo);
        return pageModel;
    }
}
